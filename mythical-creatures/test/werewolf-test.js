...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    var werewolf = new Werewolf("Melissa");
  ...
  it('should be able to eat(victim) once hungry', function() {
    var werewolf = new Werewolf("Jobe");
    var victim = new Victim("Dinah");
  ...
  it('should not be hungry after changing back to human form', function() {
    var werewolf = new Werewolf("Honey");
    var victim = new Victim("Otis");
  ...
  it('should not be able to eat a victim while in human form', function() {
    var werewolf = new Werewolf("Gerturde");
    var victim = new Victim("Oswald");
    ...
    assert.equal(werewolf.eat(victim), "I'd never eat another human!")
  });
});
